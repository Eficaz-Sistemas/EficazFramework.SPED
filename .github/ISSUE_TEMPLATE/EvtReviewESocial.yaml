...
- [ ] 🔍 Revisar a classe [<evtID>](https://github.com/Eficaz-Sistemas/EficazFramework.SPED/blob/master/src/Core/EficazFramework.SPED.Schemas/e-Social/<evtID>.cs) para assegurar conformidade com layout S-1.3 vigente;
