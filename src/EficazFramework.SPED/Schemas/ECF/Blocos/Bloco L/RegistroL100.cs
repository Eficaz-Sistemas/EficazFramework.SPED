...
namespace EficazFramework.SPED.Schemas.ECF
{
    ...
    public class RegistroL100 : Primitives.Registro
    {
        public RegistroL100() : base("L100")
        {
        }

        public RegistroL100(string linha, string versao) : base(linha, versao)
        {
        }
        ...
        /// </summary>
        public List<RegistroL100> SubContas { get; set; } = new List<RegistroL100>();
