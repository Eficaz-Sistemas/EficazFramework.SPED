...
namespace EficazFramework.SPED.Schemas.ECF
{
    ...
    public class Registro0030 : Primitives.Registro
    {
        ...
        public override string EscreveLinha()
        {
            ...
            writer.Append(NaturezaJuridica + "|"); // 2
            writer.Append(CNAE + "|"); // 3
            writer.Append(Endereco + "|"); // 4
            writer.Append(Numero + "|"); // 5
            writer.Append(Complemento + "|"); // 6
            writer.Append(Bairro + "|"); // 7
            writer.Append(UF + "|"); // 8
            writer.Append(CodigoMunicipio + "|"); // 9
            writer.Append(CEP + "|"); // 10
            writer.Append(Telefone + "|"); // 11
            writer.Append(EMail + "|"); // 12
