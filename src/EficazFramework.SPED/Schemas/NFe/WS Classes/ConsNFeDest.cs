...
namespace EficazFramework.SPED.Schemas.NFe
{
    ...
    [XmlType(TypeName = "consNFeDest", Namespace = "http://www.portalfiscal.inf.br/nfe")]
    [XmlRoot(Namespace = "http://www.portalfiscal.inf.br/nfe", IsNullable = true)]
    public partial class PedidoConsulta : INotifyPropertyChanged
    {

        /* TODO ERROR: Skipped RegionDirectiveTrivia */
        private Ambiente tpAmbField = Ambiente.Producao;
        private ServicoSolicitado xServField = ServicoSolicitado.CONSULTARNFEDEST;
        private string cNPJField = null;
        private IndicadorTipoNFe indNFeField = IndicadorTipoNFe.Todas;
        private IndicadorEmissorNFe indEmiField = IndicadorEmissorNFe.Todos;
        private long? ultNSUField = 0;
        ...
        [XmlElement("xServ")]
        public ServicoSolicitado Servico
        {
            get
            {
                return xServField;
        ...
        [XmlElement("indNFe")]
        public IndicadorTipoNFe IndicadorTipoNFeConsultada
        {
            get
            {
                return indNFeField;
            ...
            set
            {
                if (indNFeField.Equals(value) != true)
                {
                    indNFeField = value;
                    OnPropertyChanged("IndicadorTipoNFeConsultada");
                }
            }
        }

        [XmlElement("indEmi")]
        public IndicadorEmissorNFe IndicadorEmissorNFe
        {
            get
            {
                return indEmiField;
            ...
            set
            {
                if (indEmiField.Equals(value) != true)
                {
                    indEmiField = value;
                    OnPropertyChanged("IndicadorEmissorNFe");
                }
            }
        }

        /// <summary>
        /// Número de Série, Sequencial e Único de busca pelo destinatário.
        /// Incrementar '+ 1' para cada busca pelo CNPJ.
        /// </summary>
        /// <value></value>
        /// <returns></returns>
        /// <remarks></remarks>
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                ...
                {
                    sSerializer = new XmlSerializer(typeof(PedidoConsulta));
                }
        ...
        public static bool CanDeserialize(string xml, ref PedidoConsulta obj, ref Exception exception)
        {
            exception = null;
            obj = default;
            try
        ...
        public static bool CanDeserialize(string xml, ref PedidoConsulta obj)
        {
            Exception exception = null;
            return CanDeserialize(xml, ref obj, ref exception);
        }

        public static PedidoConsulta Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return (PedidoConsulta)Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader));
            }
            finally
            {
        ...
        public static PedidoConsulta Deserialize(System.IO.Stream s)
        {
            return (PedidoConsulta)Serializer.Deserialize(s);
        }
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool CanLoadFrom(System.IO.Stream source, ref PedidoConsulta obj, ref Exception exception)
        {
            exception = null;
            obj = default;
            try
        ...
        public static bool CanLoadFrom(System.IO.Stream source, ref PedidoConsulta obj)
        {
            Exception exception = null;
            return CanLoadFrom(source, ref obj, ref exception);
        }

        public static PedidoConsulta LoadFrom(System.IO.Stream source, bool close_stream = true)
        {
        ...
        public static async Task<PedidoConsulta> LoadFromAsync(System.IO.Stream source, bool close_stream = true)
        {
            if (source is null)
                throw new ArgumentException(Resources.Strings.Validation.Classes_Load_NullStreamExceptionMessage);
            System.IO.StreamReader sr = null;
