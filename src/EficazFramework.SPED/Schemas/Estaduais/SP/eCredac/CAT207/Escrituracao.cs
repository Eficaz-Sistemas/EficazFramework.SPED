...
namespace EficazFrameworkCore.SPED.Schemas.SP.eCredAc.CAT207
{
    public class Escrituracao : Primitives.Escrituracao
    {
        ...
        public Escrituracao() : base("Arquivo Eletrônico e-CredAc CAT 207/09 (SP)")
        {
            Blocos.Add("0", new Bloco0());
            Blocos.Add("5", new Bloco5());
        ...
        public override Primitives.Registro[] SufixoBlocoEncerramento()
        {
            ...
            reg9900_9900.TotalLinhas = (from reg in Blocos[BlocoTotalizador].Registros
                                        where reg is Primitives.RegistroTotalizador
                                        select reg).Count() + 4;
