...
public abstract class CadastrosEfdReinfTest<T> : Tests.BaseTest where T : Schemas.EFD_Reinf.Evento
{
    ...
    public async Task<Response> ConsultaProtocolo(string protocolo)
    {
        var _ws = new EficazFramework.SPED.Services.EFD_Reinf.EfdReinfServices
        {
            ...
            //Certificate = new IcpBrasil_X509Certificate2($"{Environment.CurrentDirectory}\\Resources\\Certificados\\0038.pfx", "1234")
        };
    ...
    /// </summary>
    /// <returns></returns>
    private static Func<Utilities.IcpBrasilX509Certificate2> InstanciaCertificado => () =>
        new Utilities.IcpBrasilX509Certificate2(Resources.Certificados.WayneEnterprisesInc, "1234");
}
