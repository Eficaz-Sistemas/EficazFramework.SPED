...
public class RegistroC490 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC490();
        reg.Codigo.Should().Be("C490");
    }

    [TestCase("|C490|000|5102|18|1000|1000|180|OBS01|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC490(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC490("", versao)
        {
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC490 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("C490");
