...
public class RegistroC890 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC890();
        reg.Codigo.Should().Be("C890");
    }

    [TestCase("|C890|000|5102|18|1000|1000|180|OBS01|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC890(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC890("", versao)
        {
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC890 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("C890");
