...
public class RegistroC590 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC590();
        reg.Codigo.Should().Be("C590");
    }

    [TestCase("|C590|000|5102|18|1000|1000|180|0|0|0|OBS01|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC590(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC590("", versao)
        {
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroC590 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("C590");
