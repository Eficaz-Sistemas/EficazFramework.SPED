...
public class RegistroE116 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE116();
        reg.Codigo.Should().Be("E116");
    }

    [TestCase("|E116|000|150,5|20012023|1111|12345|1|Desc|Txt|012023|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE116(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE116("", versao)
        {
            CodigoObrigacao = "000",
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE116 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("E116");
