...
public class RegistroE240 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE240();
        reg.Codigo.Should().Be("E240");
    }

    [TestCase("|E240|PART1|55|1||123456|01012023|ITEM1|150,5|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE240(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE240("", versao)
        {
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroE240 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("E240");
