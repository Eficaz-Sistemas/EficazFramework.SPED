...
public class RegistroD730 : Tests.BaseTest
{
    [Test]
    public void Construtor()
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroD730();
        reg.Codigo.Should().Be("D730");
    }

    [TestCase("|D730|000|5307|12|100|100|12|0|OBS01|", "016")]
    public void Construtor(string linha, string versao = "016")
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroD730(linha, versao);
    ...
    {
        var reg = new EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroD730("", versao)
        {
    ...
    private void InternalRead(EficazFramework.SPED.Schemas.EFD_ICMS_IPI.RegistroD730 reg, string versao = "016")
    {
        reg.Codigo.Should().Be("D730");
