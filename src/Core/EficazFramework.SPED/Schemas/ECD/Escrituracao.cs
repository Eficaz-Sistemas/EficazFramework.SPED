...
public class Escrituracao : Schemas.Primitives.Escrituracao
{
    ...
    {
        Schemas.Primitives.Registro reg = null;
    ...
    public override Schemas.Primitives.Registro[] PrefixoBlocoEncerramento()
    {
        ...
        {
            reg.IndicadorMovimento = Schemas.Primitives.IndicadorMovimento.ComDados;
        }
