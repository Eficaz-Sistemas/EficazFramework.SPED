...
/// </summary>
public class Registro21 : Primitives.Registro
{
    public Registro21() : base("21")
    {
    }

    public Registro21(string linha, string versao) : base(linha, versao)
    {
    }
    ...
    public override string EscreveLinha()
    {
        ...
        writer.Append("21"); // 1 Código Registro
