...
{
    public class IdeTrabalhador : ESocialBindableObject
    {
    ...
    public class InfoMV : ESocialBindableObject
    {
        ...
        public List<RemunOutrEmpr> RemunOutrEmpr
        {
            get => remunOutrEmpr;
            set
            {
    ...
    public class RemunOutrEmpr : ESocialBindableObject
    {
