...
public class InformacoesNfse : NFSeNacionalBase
{
    ...
    /// </summary>
    [XmlElement("ambGer")]
    public AmbienteGerador AmbienteGerador
    {
        get => _ambGer;
...
public class DeclaracaoPrestacaoServico : NFSeNacionalBase, IXmlSpedDocument
{
    ...
    /// <summary>
    /// Serializa a instância atual da DPS em uma string XML.
    /// </summary>
    public virtual string Serialize()
    {
        System.IO.StreamReader streamReader = null!;
...
public class InformacoesDps : NFSeNacionalBase
{
    ...
    /// <summary>
    /// Grupo de informações relativas a valores do serviço prestado.
    /// </summary>
    [XmlElement("valores")]
...
public class Endereco : NFSeNacionalBase
{
    ...
    [XmlElement("endNac")]
    public EnderecoNacional? Nacional
    {
        get => _endNac;
...
public class Servico : NFSeNacionalBase
{
    ...
    [XmlElement("locPrest")]
    public LocalPrestacaoServico? LocalPrestacao
    {
        get => _locPrest;
    ...
    [XmlElement("cServ")]
    public InfoServico? InfoServico
    {
        get => _cServ;
...
public class TotalValores : NFSeNacionalBase
{
    ...
    public ValorServicoPrestado? ValoresPrestacao
    {
        get => _vServPrest;
    ...
    [XmlElement("trib")]
    public InfoTributacao? Tributos
    {
        get => _trib;
...
public class InfoTributacao : NFSeNacionalBase
{
    ...
    [XmlElement("tribMun")]
    public TributacaoMunicipal? Municipais
    {
        get => _tribMun;
    ...
    [XmlElement("totTrib")]
    public TributacaoTotal? TotalTributos
    {
        get => _totTrib;
...
public class TributacaoTotal : NFSeNacionalBase
{
    ...
    [XmlElement("vTotTrib")]
    public TributacaoTotalMoeda? ValorTotalTributos
    {
        get => _vTotTrib;
