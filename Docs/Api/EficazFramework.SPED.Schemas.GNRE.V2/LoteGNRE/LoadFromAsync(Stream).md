...
```csharp
public static System.Threading.Tasks.Task<EficazFramework.SPED.Schemas.GNRE.V2.LoteGNRE> LoadFromAsync(System.IO.Stream source);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.GNRE.V2.LoteGNRE.LoadFromAsync(System.IO.Stream).source'></a>
