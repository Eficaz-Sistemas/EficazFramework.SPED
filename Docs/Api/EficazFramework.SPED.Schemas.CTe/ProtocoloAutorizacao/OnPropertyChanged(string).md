...
## ProtocoloAutorizacao.OnPropertyChanged(string) Method
...
<a name='EficazFramework.SPED.Schemas.CTe.ProtocoloAutorizacao.OnPropertyChanged(string).propertyName'></a>
