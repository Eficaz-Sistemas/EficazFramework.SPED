...
## IdentificacaoOperacao.OnPropertyChanged(string) Method
...
<a name='EficazFramework.SPED.Schemas.CTe.IdentificacaoOperacao.OnPropertyChanged(string).propertyName'></a>
