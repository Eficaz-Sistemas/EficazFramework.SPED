...
```csharp
public static EficazFramework.SPED.Schemas.CTe.CabecalhoMensagem Deserialize(string xml);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.CTe.CabecalhoMensagem.Deserialize(string).xml'></a>
