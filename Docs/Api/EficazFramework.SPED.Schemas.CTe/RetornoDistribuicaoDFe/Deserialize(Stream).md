...
## RetornoDistribuicaoDFe.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.CTe.RetornoDistribuicaoDFe Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.CTe.RetornoDistribuicaoDFe.Deserialize(System.IO.Stream).s'></a>
