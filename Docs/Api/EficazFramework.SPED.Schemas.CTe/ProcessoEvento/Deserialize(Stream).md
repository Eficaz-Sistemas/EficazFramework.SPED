...
## ProcessoEvento.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.CTe.ProcessoEvento Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.CTe.ProcessoEvento.Deserialize(System.IO.Stream).s'></a>
