...
## CabecalhoMensagem_CteConsulta.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.CTe.CabecalhoMensagem_CteConsulta Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.CTe.CabecalhoMensagem_CteConsulta.Deserialize(System.IO.Stream).s'></a>
