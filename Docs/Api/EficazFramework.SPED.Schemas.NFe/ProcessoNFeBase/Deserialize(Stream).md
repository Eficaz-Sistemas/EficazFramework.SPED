...
## ProcessoNFeBase.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.NFe.ProcessoNFeBase Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.NFe.ProcessoNFeBase.Deserialize(System.IO.Stream).s'></a>
