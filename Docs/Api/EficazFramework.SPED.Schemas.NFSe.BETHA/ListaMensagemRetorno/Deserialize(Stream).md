...
## ListaMensagemRetorno.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.NFSe.BETHA.ListaMensagemRetorno Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.NFSe.BETHA.ListaMensagemRetorno.Deserialize(System.IO.Stream).s'></a>
