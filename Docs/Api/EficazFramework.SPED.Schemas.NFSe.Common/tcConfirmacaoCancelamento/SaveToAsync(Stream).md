...
## tcConfirmacaoCancelamento.SaveToAsync(Stream) Method
...
<a name='EficazFramework.SPED.Schemas.NFSe.Common.tcConfirmacaoCancelamento.SaveToAsync(System.IO.Stream).target'></a>
