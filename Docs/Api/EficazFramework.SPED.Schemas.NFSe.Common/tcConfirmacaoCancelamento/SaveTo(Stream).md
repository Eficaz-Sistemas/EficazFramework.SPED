...
## tcConfirmacaoCancelamento.SaveTo(Stream) Method
...
<a name='EficazFramework.SPED.Schemas.NFSe.Common.tcConfirmacaoCancelamento.SaveTo(System.IO.Stream).target'></a>
