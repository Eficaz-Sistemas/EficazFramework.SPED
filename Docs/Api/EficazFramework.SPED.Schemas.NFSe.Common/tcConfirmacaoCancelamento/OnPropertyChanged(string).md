...
## tcConfirmacaoCancelamento.OnPropertyChanged(string) Method
...
<a name='EficazFramework.SPED.Schemas.NFSe.Common.tcConfirmacaoCancelamento.OnPropertyChanged(string).propertyName'></a>
