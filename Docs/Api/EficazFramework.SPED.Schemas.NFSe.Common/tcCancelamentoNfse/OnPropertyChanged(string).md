...
## tcCancelamentoNfse.OnPropertyChanged(string) Method
...
<a name='EficazFramework.SPED.Schemas.NFSe.Common.tcCancelamentoNfse.OnPropertyChanged(string).propertyName'></a>
