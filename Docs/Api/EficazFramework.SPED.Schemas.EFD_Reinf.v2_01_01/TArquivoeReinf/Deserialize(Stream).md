...
```csharp
public static EficazFramework.SPED.Schemas.EFD_Reinf.v2_01_01.TArquivoeReinf Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.EFD_Reinf.v2_01_01.TArquivoeReinf.Deserialize(System.IO.Stream).s'></a>
