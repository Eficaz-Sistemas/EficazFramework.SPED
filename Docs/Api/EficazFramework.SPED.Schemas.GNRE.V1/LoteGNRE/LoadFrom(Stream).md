...
```csharp
public static EficazFramework.SPED.Schemas.GNRE.V1.LoteGNRE LoadFrom(System.IO.Stream source);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.GNRE.V1.LoteGNRE.LoadFrom(System.IO.Stream).source'></a>
