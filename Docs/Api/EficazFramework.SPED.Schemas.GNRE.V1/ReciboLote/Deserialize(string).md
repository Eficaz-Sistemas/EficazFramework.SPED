...
## ReciboLote.Deserialize(string) Method

```csharp
public static EficazFramework.SPED.Schemas.GNRE.V1.ReciboLote Deserialize(string xml);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.GNRE.V1.ReciboLote.Deserialize(string).xml'></a>
