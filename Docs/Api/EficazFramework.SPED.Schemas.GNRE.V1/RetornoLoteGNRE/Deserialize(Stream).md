...
## RetornoLoteGNRE.Deserialize(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.GNRE.V1.RetornoLoteGNRE Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.GNRE.V1.RetornoLoteGNRE.Deserialize(System.IO.Stream).s'></a>
