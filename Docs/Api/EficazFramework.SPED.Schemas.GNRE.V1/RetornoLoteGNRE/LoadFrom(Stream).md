...
## RetornoLoteGNRE.LoadFrom(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.GNRE.V1.RetornoLoteGNRE LoadFrom(System.IO.Stream source);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.GNRE.V1.RetornoLoteGNRE.LoadFrom(System.IO.Stream).source'></a>
