...
## CancelamentoCFe.LoadFrom(Stream) Method

```csharp
public static EficazFramework.SPED.Schemas.SAT_CFe.CancelamentoCFe LoadFrom(System.IO.Stream source);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.SAT_CFe.CancelamentoCFe.LoadFrom(System.IO.Stream).source'></a>
