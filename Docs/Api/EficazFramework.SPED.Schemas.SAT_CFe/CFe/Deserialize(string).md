...
## CFe.Deserialize(string) Method

```csharp
public static EficazFramework.SPED.Schemas.SAT_CFe.CFe Deserialize(string xml);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.SAT_CFe.CFe.Deserialize(string).xml'></a>
