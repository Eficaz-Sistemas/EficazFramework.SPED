...
```csharp
public static EficazFramework.SPED.Schemas.EFD_Reinf.v1_05.RetornoLoteEventos Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.EFD_Reinf.v1_05.RetornoLoteEventos.Deserialize(System.IO.Stream).s'></a>
