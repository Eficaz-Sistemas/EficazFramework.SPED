...
```csharp
public static EficazFramework.SPED.Schemas.EFD_Reinf.TArquivoeReinf Deserialize(System.IO.Stream s);
```
#### Parameters

<a name='EficazFramework.SPED.Schemas.EFD_Reinf.TArquivoeReinf.Deserialize(System.IO.Stream).s'></a>
